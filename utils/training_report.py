...
DASHBOARD_PLOTS = [
    ...
    (
        'Modality Classifier Accuracy',
        [
            ('train_modality_acc', 'Original embeddings'),
            ('train_modality_ts_acc', 'Transformed-image embeddings'),
        ],
    ),
    (
...
LOSS_DASHBOARD_PLOTS = [
    ...
    {
        'title': 'Train Modality Adversary Loss',
        'optional': True,
        'activation_weight_field': 'train_loss_modality_weight',
        'series': [
            {
                'field': 'train_loss_modality_weighted',
                'weight_field': 'train_loss_modality_weight',
                'default_weight': 0.0,
                'label': 'Train modality adversary',
            },
        ],
    },
]
